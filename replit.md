...
- **Automatic Version Tracking**:
  ...
  - Format: `v1.1.126 (6c90b87) - 2025-11-26`
  - **Build-time versioning**: Version info is now stored in `build-info.json` at project root
  - The file is generated by `scripts/generate-build-info.js` (run before deploying)
  - Server reads from file first, falls back to git commands if file not found
  - Replit autoscale deployments include the entire workspace, so the file persists in production
